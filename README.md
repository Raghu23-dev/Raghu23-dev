...
| **Hybrid Code-RAG Pipeline** | Codebase indexing + hybrid retrieval grounding the agents — lexical + semantic + structural signals fused with RRF and an 8-intent query planner.<br>`Tree-sitter` · `SQLite FTS5 BM25` · `sqlite-vec` · `Azure OpenAI` · `Cohere Rerank` · `RRF` | powers<br>the agents |
...
<!-- Snake animation renders after the "Generate Snake" Action runs once (see .github/workflows/snake.yml) -->
<div align="center">
  <img width="98%" alt="Contribution snake" src="https://raw.githubusercontent.com/Raghu23-dev/Raghu23-dev/output/snake.svg" />
</div>
